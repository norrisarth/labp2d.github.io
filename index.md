...
Efficient Computing Clouds Program with Free Software and Hardware - COLMÉIA 2022-2023
...
**16.**
JUNIOR, E.C. ; M**IERS, C. C.** ; KOSLOVSKI, G. . A taxonomy for IaaS cloud brokerage based on virtual infrastructure migration. BRAZILIAN JOURNAL OF APPLIED COMPUTING, v. 9, p. 15-30, 2017.
...
(https://github.com/DanielFloripa/EAVIRA_CHAVE)
</p>
<p>
...
GreenHop is an open source system for real-time PUE monitoring of servers, using free-software and free-hardware components.(https://github.com/DanielFloripa/GreenHop)
</p>
...
MonTerDC Architecture.(https://github.com/ademircamillo/monterdc).
</p>
...
Implementation of a elastic energy-aware virtual infrastructure realocation algorithm in Python.(https://bitbucket.org/denivyruck/eavira/src/master/)
